...
@property(nonatomic, strong) NSArray<CBDescriptor *> *descriptors;
@property(nonatomic, strong) CBCharacteristic *charRecvFW;
@property(nonatomic, strong) CBCharacteristic *charCommand;
